  ...
  return (
    <div className="formula-page">
      <header className="formula-header">
        <a className="formula-brand site-link brand-link brand-link--header" href="/" aria-label="Return to Bella Nissa Science home">
          <img src={ASSETS.logo} alt="BNS scientific emblem" />
          <span><b>Bella Nissa</b><small>SCIENCE / BNS</small></span>
        </a>
        <a className="formula-back site-link brand-link" href="/"><ArrowLeft size={15} /> Return to the system</a>
      </header>
      ...
      <main>
        <section className="formula-hero" aria-labelledby="formula-title">
          <div className="formula-hero__copy">
            ...
            <a className="formula-scroll site-link brand-link" href="#substantiation">Read the substantiation framework <ChevronRight size={16} /></a>
          </div>
          <div className="formula-hero__specimen">
            <img src={ASSETS.serum} alt="Bella Nissa Science Bioactive Renewal Serum" />
            <div className="formula-hero__seal"><img src={ASSETS.logo} alt="" /><span>BNS<br />FORMULA<br />DOSSIER</span></div>
          ...
          <div className="evidence-ledger">
            ...
            {evidenceRows.map((row, index) => (
              <article className="evidence-row" key={row.group}>
                ...
                <div className="evidence-row__copy"><p>{row.copy}</p><a className="site-link brand-link" href={row.href} target="_blank" rel="noreferrer">{row.source} <ArrowUpRight size={13} /></a></div>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="testing-section" aria-labelledby="testing-title">
          ...
          <div className="testing-note"><img src={ASSETS.logo} alt="BNS molecular badge" /><p><b>FORMULA STANDARD</b> Any public Bella Nissa Science performance claim should be supported by a finished-product protocol that matches the claim, the use directions, and the product as sold.</p></div>
        </section>
        ...
        <section className="formula-close">
          ...
          <a href="/" className="formula-return site-link brand-link">Back to the serum + device <ArrowUpRight size={17} /></a>
        </section>
      </main>
    </div>
  );
