  ...
  return (
    <div className="formula-page">
      <header className="formula-header">
        <a className="formula-brand" href="/" aria-label="Return to Bella Nissa Science home">
          <img src={ASSETS.logo} alt="BNS scientific emblem" />
          <span><b>Bella Nissa</b><small>SCIENCE / BNS</small></span>
        </a>
        <a className="formula-back" href="/"><ArrowLeft size={15} /> Return to the system</a>
      </header>
      ...
      <main>
        <section className="formula-hero" aria-labelledby="formula-title">
          <div className="formula-hero__copy">
            ...
            <a className="formula-scroll" href="#substantiation">Read the substantiation framework <ChevronRight size={16} /></a>
          </div>
          ...
          <div className="evidence-ledger">
            ...
            {evidenceRows.map((row, index) => (
              <article className="evidence-row" key={row.group}>
                ...
                <div className="evidence-row__copy"><p>{row.copy}</p><a href={row.href} target="_blank" rel="noreferrer">{row.source} <ArrowUpRight size={13} /></a></div>
              </article>
            ))}
          </div>
        </section>
        ...
        <section className="formula-close">
          ...
          <a href="/" className="formula-return">Back to the serum + device <ArrowUpRight size={17} /></a>
        </section>
      </main>
    </div>
  );
